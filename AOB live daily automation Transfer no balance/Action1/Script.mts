...
Browser("Home - Advantage Bank").Page("Home - Advantage Bank").WebButton("Sign-In").Click @@ script infofile_;_ZIP::ssf23.xml_;_
...
If Browser("Home - Advantage Bank").Page("Home - Advantage Bank").Webtext("Payment done").Exist Then @@ script infofile_;_ZIP::ssf4.xml_;_
Reporter.ReportEvent micPass, " Transfer live", "  Transfer live passed  !"
else
	Reporter.ReportEvent micFail, " Transfer live ", " Failed -Transfer confirmation not triggered after successful payment" 
	ExitTest("Transfer  confirmation not triggered after successful payment")
End If
