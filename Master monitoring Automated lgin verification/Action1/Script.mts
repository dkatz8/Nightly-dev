...
If Browser("Home - Advantage Bank").Page("Dashboard - Advantage").Link("New Transfer").Exist Then @@ script infofile_;_ZIP::ssf4.xml_;_
Reporter.ReportEvent micPass, "AOB Transfer", " AOB is UP Transfer live !"
else
	Reporter.ReportEvent micFail, "AOB Transfer ", " Transfer refused by gateway - status: DECLINED" 
	ExitTest("Transfer refused by gateway - status: DECLINED .")
End If
